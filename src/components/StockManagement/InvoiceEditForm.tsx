...
interface BillRow {
  ...
  spareName: string;
  manufacturer: string;
  quantity: string; // stored as string for editing
  rate: string; // stored as string for editing
  discountPercent: string; // stored as string for editing
  discountAmt: number;
  cgstPercent: number;
  cgstAmt: number;
  sgstPercent: number;
...
// Recalculate spare row totals with safe defaults.
...
// Recalculate bill row totals with safe defaults.
...
// Helper function for handling changes in spare row fields.
